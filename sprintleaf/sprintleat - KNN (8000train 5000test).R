...
test_origin <- read.csv("data/Springleaf/test.csv", head= T,nrows=5000)
...
write.csv(submission, "data/knn_submission.csv",row.names=FALSE)
a <- read.csv("data/knn_submission.csv", head= T)
