...
test_origin <- read.csv("data/Springleaf/test.csv", head= F,skip = 60001, nrows=5000)
...
write.csv(submission, "data/knn_submission12.csv",row.names=FALSE)
a12 <- read.csv("data/knn_submission12.csv", head= T)




a12 <- read.csv("data/knn_submission12.csv", head= T)
a13 <- read.csv("data/knn_submission13.csv", head= T)
a14 <- read.csv("data/knn_submission14.csv", head= T)
a15 <- read.csv("data/knn_submission14.csv", head= T)